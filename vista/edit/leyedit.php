...
<!-- Modal REGISTRAR LEY-->
<div class="modal fade" id="modal_registrar_ley" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registrar nueva Ley</h5>
        ...
        <div class="row">
          <div class="row" hidden>
            ...
            <div class="col-6">
              ...
              <input class="form-control" type="text" id="ley_ico_name_new">
            </div> 
          </div>
          ...
          <div class="col-4">
            <div class="form-group">
              ...
              <select class="select2-icon" id="ley_ico_new_val" name="icon">
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <textarea type="text" id="ley_contenido" class="form-control" style="height: 100px;"></textarea>
            </div>
          </div>
        </div>
      </div>
      <div class="modal-footer">
        ...
        <button onclick="Registrar_Ley();" type="button" class="btn btn-primary">Agregar Ley</button>
      </div>
    </div>
  </div>
</div>
...
<!-- Modal EDITAR LEY-->
<div class="modal fade" id="modal_editar_ley" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Editar Ley</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="row" hidden>
            ...
            <div class="col-6">
              <label for="">font name</label>
              <input class="form-control" type="text" id="ley_ico_name_edit">
            </div> 
          </div>
          <div class="col-4">
            <label for="">Ícono Actual</label>
            <div class="input-group mb-3">
              <input type="text" class="form-control" id="ley_ico_act_name" disabled>
              <div class="input-group-append">
                <div class="input-group-text">
                  <span class="fas fa-eye" id="ley_ico_act"></span>
                </div>
              </div>
            </div>
          </div>   
          <div class="col-8">
            <div class="form-group">
              <label for="">Ícono</label><br>
              <select class="select2-icon" id="ley_ico_edit_val" name="icon">
                <option value="fa-cubes" data-icon="fa-cubes">Cubos</option>
                <option value="fa-percent" data-icon="fa-percent">Porcentaje</option>
                <option value="fa-award" data-icon="fa-award">Escarapela</option>
                <option value="fa-smile-beam" data-icon="fa-smile-beam">Sonrisa</option>
          ...
          <div class="col-12">
            <div class="form-group">
              <label for="">Contenido</label>
              <textarea type="text" id="ley_contenido_edit" class="form-control" style="height: 100px;"></textarea>
            </div>
          </div>
        </div>
      </div>
