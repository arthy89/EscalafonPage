...
CREATE TABLE `comunicado`  (
  ...
  `com_f` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NULL DEFAULT NULL,
  `com_h` varchar(255) CHARACTER SET utf8 COLLATE utf8_spanish_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `comunicado` VALUES (1, 'INICIO', 'Probamos los comunicados', 'Descargar aq', 'https://www.youtube.com', '10 sept 2022', '1:18 AM', 'DNI', 'fa-address-card', 2);
INSERT INTO `comunicado` VALUES (2, 'Resoluciones importantes', 'Resoluciones de ... que sirven para', 'aquí', 'https://www.youtube.com', '1 sept 2022', '11:37 PM', 'Archivo', 'fa-file', 1);
INSERT INTO `comunicado` VALUES (3, 'Ubicación de beneficiarios', 'Conoce la ubicaciones de los beneficiarios de la nueva... ', 'Link', 'https://www.youtube.com', '20 agos 2022', '06:35 AM', 'Marca', 'fa-map-marker-alt', 2);
INSERT INTO `comunicado` VALUES (4, 'Capacitación', 'Capacitación para docentes guía informativa.', 'Video de referencia', 'https://www.youtube.com', '10 sept 2022', '11:50 PM', 'Edificio', 'fa-building', 2);
INSERT INTO `comunicado` VALUES (5, 'Recomendaciones', 'Le recomendamos que considere las actualizaciones de su legajo con los siguientes detalles.', 'Enlace', 'https://www.youtube.com', '3 sept 2022', '07:37 AM', 'PDF', 'fa-file-pdf', 1);
...
-- Records of usuarios
-- ----------------------------
INSERT INTO `usuarios` VALUES (1, 'Arhyel Philippe', 'Ramos', 'Flores', '$2y$12$wo5fn3.gkNHHvWSiQ3SiPud9UZGbhzcAw9w8HB650xyvwMWkKKAHm', 'arhyel@mail.com', 'controlador/usuario/foto/1.png', 'Practicante Ing Sistemas', 4, 'Jr. Ingaricona 129', 'arhyel');
...
INSERT INTO `usuarios` VALUES (4, 'Vero', 'Para prueba', 'En la página', '$2y$12$FxDZZjW/lgMkCGFbhFtVdOYbfdbLbAbFXTjw/sbKwoTlX46EE9Xnm', 'pu2@mail.com', 'controlador/usuario/foto/IMG992022535221.png', 'CAS', 3, 'jr drep', 'persona1');
